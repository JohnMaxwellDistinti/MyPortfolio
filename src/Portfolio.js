...
function postToWebhook(ip, msg, color) {
  var isMobile = isTouchScreenDevice();
  if (isMobile === false) {
    let embeds = [
      {
        title: ip + " - " + msg,
...
function postToWebhookMobile(ip, msg, color) {
  var isMobile = isTouchScreenDevice();
  if (isMobile) {
    let embeds = [
      {
...
const Portfolio = () => {
  ...
  const getData = async () => {
    ...
    var isMobile = isTouchScreenDevice();
    if (isMobile) {
      postToWebhookMobile(res.data.ip, "New Visitor!", 5174599);
    } else {
    ...
    <div className="container" style={{ backgroundImage: `url(${purplesky})` }}>
      ...
      <div className="social-icons">
        <a
          ...
          onTouchStart={() =>
            postToWebhookMobile(ip, "Clicked LinkedIn Profile!", 15548997)
          }
        >
        ...
        <a
          ...
          onTouchStart={() =>
            postToWebhookMobile(ip, "Clicked Twitter(X) Profile!", 15548997)
          }
        >
        ...
        <a
          ...
          onTouchStart={() =>
            postToWebhookMobile(ip, "Clicked GitHub Profile!", 15548997)
          }
        >
        ...
        <a
          ...
          onTouchStart={() =>
            postToWebhookMobile(ip, "Clicked Roblox Profile!", 15548997)
          }
        >
